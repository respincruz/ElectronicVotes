        ...
        <div class="row login-box">
            <div class="col-lg-6 align-self-center pad-0">
                <div class="form-section align-self-center">
                    <h3 class="c-font-label">Ingrese con su cuenta</h3>
                    ...
                    <form action="#" method="GET">
                        ...
                        <div class="form-group form-box clearfix">
                            <input type="password" name="Password" id="txtPassword" class="input-text" placeholder="Contraseña">
                            <input type="hidden" id="hCodAgencia" value=""/>
                        </div>
                        <div class="form-group clearfix mb-0">
                            <button type="button" id="btnLogin" class="btn-md bg float-left f-bold">Ingresar</button>
                            <button type="button" id="btnVolver" class="btn-md bg float-left f-bold">Volver</button>
            ...
            <div class="col-lg-6 bg-color-15 align-self-center pad-0 none-992 heightlogin">
                <div class="info clearfix bg-white">
                    <div class="">
                        <a href="index.html">
...
<script  src="js/jsLogin.js?rand=<?php echo uniqid();?>"></script>
</body>
</html>