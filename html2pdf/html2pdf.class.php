...
if (!defined('__CLASS_HTML2PDF__')) {
    ...
    class HTML2PDF
    {
         ...
         */
        public function __construct($orientation = 'P', $format = 'A4', $langue='es', $unicode=true, $encoding='UTF-8', $marges = array(5, 5, 5, 5))
        {
        ...
        public function Output($name = '', $dest = false)
        {
			...
			ob_end_clean(); //resuelto para headers
...
'.$content.'
        ...
        protected function _tag_open_WRITE($param)
        {
			...
			//AQUI NUMERO DE PAGINA
		
			
			
			$txt = str_replace('[[page_cu]]', $this->pdf->getMyNumPage($this->_page/*+11*/), $txt);
